...
show_debug_message("[BGM]: Object " + string(object_index) + ", " + object_get_name(object_index) + " switched the BGM from " + audio_get_name(bgm_current) + " to " + audio_get_name(new_bgm) + ", volume " + string(vol) + ".")
